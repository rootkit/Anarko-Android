...
* MPEG-4 FBA standard,
* and groups 12 and 14 contain additional feature points that are not part of the MPEG-4 standard (12.1, 12.5, 12.6, 12.7, 12.8, 12.9, 12.10, 12.11, 12.12, 14.1, 14.2, 14.3, 14.4).
* 
...
public:
	...
	* @param group Feature point group. Valid range is from 2 to 14.
	...
	*/
	...
	static const int FP_END_GROUP_INDEX = 14;

	/// Number of groups.
	static const int FP_NUMBER_OF_GROUPS = 13;
...
public:
	...
	* Valid range for group is from 2 to 14.
	*
	* @param group Feature point group. Valid range is from 2 to 14.
	*
