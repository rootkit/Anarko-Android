...
public enum CardType implements Serializable {
    VISA("VISA", R.drawable.icon_store_card_visa_enabled, CardRegex.REGX_VISA, CardRegex.REGX_VISA_TYPE),
    MASTERCARD("MasterCard", R.drawable.icon_store_card_mastercard_enabled, CardRegex.REGX_MC, CardRegex.REGX_MC_TYPE),
    AMEX("American Express", R.drawable.icon_store_amex_enabled, CardRegex.REGX_AMEX, CardRegex.REGX_AMEX_TYPE),
    DISCOVER("Discover", R.drawable.icon_store_card_discover_enabled, CardRegex.REGX_DISCOVER, CardRegex.REGX_DISCOVER_TYPE),
    DINERS("DinersClub",R.drawable.icon_store_card_diners_enabled,CardRegex.REGX_DINERS_CLUB,CardRegex.REGX_DINERS_CLUB_TYPE),
    JCB("JCB",R.drawable.icon_store_card_jcb_enabled,CardRegex.REGX_JCB,CardRegex.REGX_JCB_TYPE),
    INVALID("Unknown", R.drawable.icon_store_card_num, null, null);
  ...
  /** drawable for the back of the card */
    public final int backResource = R.drawable.icon_store_card_back_num;
