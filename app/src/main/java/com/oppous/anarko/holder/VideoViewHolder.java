...
import com.oppous.anarko.BuildConfig;
...
import com.oppous.anarko.VideoList.VideoListGlideModule;
...
import com.oppous.anarko.models.VideoLoadMvpView;
import com.oppous.anarko.target.VideoLoadTarget;
import com.oppous.anarko.target.VideoProgressTarget;
...
public class VideoViewHolder extends BaseViewHolder<VideoItem>
    ...
    @Bind(R.id.video_layout_load)
    public FrameLayout layoutLoad;

    @Bind(R.id.video_progressBar)
    public AKProgressBar progressBar;
    ...
    public VideoViewHolder(View view) {
        ...
        progressTarget = new VideoProgressTarget(videoTarget, progressBar, layoutLoad);
        ...
        if (videoView != null){
            videoView.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    ...
                    mVideoViewHolderListener.onLongPressed();
    ...
    public void setVideoViewHolderListener(VideoViewHolderListener listener) {
        if (listener != null)
            mVideoViewHolderListener = listener;
    }

    public void enableClick(boolean flag){
        if (videoView != null){
            videoView.setEnabled(flag);
        }
    }
